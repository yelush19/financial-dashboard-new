...
import SingleMonthPLReport from "./components/reports/SingleMonthPL/SingleMonthPLReport";
...
const tabs = [
  ...
  { id: 'monthly-single', label: "P&L תצוגת חודש", icon: TrendingUp },
        ...
        <div className="w-full">
          <div className="bg-white rounded-xl shadow-lg border border-gray-200" style={{ borderRight: `4px solid ${LITAY.primary}` }}>
            <div className="p-6">
              ...
              {selectedTab === 'monthly-single' && <SingleMonthPLReport />}
